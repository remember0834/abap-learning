CLASS LHC_ZR_20260319FLIGHT DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
...
CLASS LHC_ZR_20260319FLIGHT IMPLEMENTATION.
  ...
  METHOD validatePrice.
    ...
    READ ENTITIES OF zr_20260319flight IN LOCAL MODE
        ENTITY flight
        FIELDS ( price )
